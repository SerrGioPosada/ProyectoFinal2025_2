...
public class SignupController {
    ...
    // Floating labels
    @FXML
    private Label lblNameFloat;
    @FXML
    private Label lblLastNameFloat;
    @FXML
    private Label lblEmailFloat;
    @FXML
    private Label lblPhoneFloat;
    @FXML
    private Label lblPasswordFloat;
    @FXML
    private Label lblConfirmPasswordFloat;
    ...
    private void setupFloatingLabels() {
        ...
        setupFieldListeners(txtConfirmPassword, lblConfirmPasswordFloat, "CONFIRMAR CONTRASEÑA");
    }
