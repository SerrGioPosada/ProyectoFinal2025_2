...
public class UserSidebarController extends BaseSidebarController {
    ...
    private void setupButtonActions() {
        ...
        if (btnDashboard != null) btnDashboard.setOnAction(event -> {
        ...
        btnNewShipment.setOnAction(event -> {
            setActiveButton(btnNewShipment);
            handleNewShipment();
        });
        ...
        btnTrackShipment.setOnAction(event -> {
    ...
    private void updateButtonVisibility() {
        ...
        setButtonVisibility(btnDashboard, isLoggedIn);
     ...
     *
     * @param viewName The name of the view file (e.g., "UserDashboard.fxml")
     */
    public void setActiveView(String viewName) {
        Button buttonToActivate = switch (viewName) {
            case "Login.fxml" -> btnLogin;
            case "Signup.fxml" -> btnSignup;
            case "UserDashboard.fxml" -> btnDashboard;
            case "UserProfile.fxml" -> btnProfile;
