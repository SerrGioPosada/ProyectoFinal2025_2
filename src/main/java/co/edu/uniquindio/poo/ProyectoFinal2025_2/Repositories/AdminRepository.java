...
public class AdminRepository {
    ...
    public void updateAdmin(Admin admin) {
        ...
        // Verify admin exists in repository
        if (!adminsById.containsKey(admin.getId())) {
            Logger.warning("Cannot update admin: Admin with ID " + admin.getId() + " not found in repository");
            return;
        }

        Logger.info("Updating admin: " + admin.getEmail() + " (ID: " + admin.getId() + ")");
        ...
        saveToFile();
        Logger.info("Admin updated and saved to file");
    }
