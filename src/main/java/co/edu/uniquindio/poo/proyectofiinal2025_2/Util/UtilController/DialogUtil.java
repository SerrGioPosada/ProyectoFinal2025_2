...
public final class DialogUtil {
    ...
    public static void showProfileDialog(Person person, Image defaultImage, double width, double height) {
        ...
        ImageView imgView = new ImageView(person instanceof AuthenticablePerson authPerson && authPerson.getProfileImagePath() != null
                ? ImageUtil.safeLoad(authPerson.getProfileImagePath())
                : defaultImage);
