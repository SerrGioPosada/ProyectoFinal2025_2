...
public class AdminProfileController implements Initializable {
    ...
    private void loadProfileImage() {
        try {
            ...
            Image defaultImage = new Image(getClass().getResourceAsStream("/co/edu/uniquindio/poo/proyectofiinal2025_2/Images/default-userImage.png"));
    ...
    private void openSubView(String fxmlFile, String title) {
        try {
            FXMLLoader loader = new FXMLLoader(
                getClass().getResource("/co/edu/uniquindio/poo/proyectofiinal2025_2/View/" + fxmlFile)
            );
